"""
Django settings for pedagogIA project.
...
SECRET_KEY = "django-insecure-n@t)n7k%0um=aj-7lokxouq&1r((p#6r2hs$^ryk^$89%=c3dt"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['thiagodebia.pythonanywhere.com', '127.0.0.1']
